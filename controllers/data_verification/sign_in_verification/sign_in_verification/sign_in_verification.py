...
from controllers.data_verification.sign_in_verification.sign_in_data import sign_in_data
from controllers.data_verification.sign_in_verification.sign_in_errors import sign_in_errors
from controllers.data_verification.sign_in_verification.sign_in_post import sign_in_post
...
def sign_in_verification(e):

    # Obtencion de campos de registro:

    user_data = sign_in_data.data_extraction(e)
    user_email = user_data["user_email"]
    user_password = user_data["user_password"]

    fields_validation = sign_in_errors.sign_in_error_fields(user_email,user_password)
    ...
    if fields_validation:
        ...
        if len(errors_log)>= 1:
            ...
            sign_in_post.sign_in_post(e,user_email,user_password)
