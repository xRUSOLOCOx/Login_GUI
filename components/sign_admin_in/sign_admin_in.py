...
from controllers.data_verification.sign_admin_in_verification.sign_admin_in_verification import sign_admin_in_verification



def sign_admin_in_component():
        ...
        return ft.Container(
            ...
            [
                ...
                ft.TextField(
                    ...
                    width=550,
                    border_color="white",
                    on_blur=lambda e: sign_admin_in_errors.sign_admin_in_errors(e)
                ...
                ft.Button(
                    ...
                    on_click=lambda e: sign_admin_in_verification.sign_admin_in_verification(e)
